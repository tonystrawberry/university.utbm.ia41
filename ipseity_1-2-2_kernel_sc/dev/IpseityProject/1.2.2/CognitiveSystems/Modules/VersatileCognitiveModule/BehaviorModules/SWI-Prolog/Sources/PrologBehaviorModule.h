...
#ifndef PrologBehaviorModule_h
#define PrologBehaviorModule_h


#include "AL/AbstractVersatileBehaviorModule.h"
#include "IO/PrologInterface.h"


class PrologBehaviorModule : public AbstractVersatileBehaviorModule
{
    public:
        PrologBehaviorModule();
        ~PrologBehaviorModule();
