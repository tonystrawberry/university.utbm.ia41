...
INCLUDEPATH += $$COMMON_PATH $$DEV_ROOTDIR/API/$$OS/pl/include/ Sources/
...
HEADERS += \
    ...
    $$COMMON_PATH/IO/PrologInterface.h \
    Sources/*.h

SOURCES += \
    $$COMMON_PATH/AL/Response.cpp \
    $$COMMON_PATH/AL/Stimulus.cpp \
    $$COMMON_PATH/IO/PrologInterface.cpp \
    Sources/PrologBehaviorModule.cpp \
    Sources/main.cpp
