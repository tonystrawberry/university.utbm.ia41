...
#ifndef ParameterSchedule_h
#define ParameterSchedule_h
...
class ParameterSchedule : public AbstractParameterScheduleModule
{
    public:
        INTERFACE_ABSTRACT_PLUGIN
		IMPLEMENTABLE_PSM_METHODS


	protected:
		Ipseity::Scalar m_AsymptoticSpeed;
};
