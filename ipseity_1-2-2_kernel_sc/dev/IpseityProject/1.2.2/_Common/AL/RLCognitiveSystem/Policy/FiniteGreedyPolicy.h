...
#ifndef FiniteGreedyPolicy_h
#define FiniteGreedyPolicy_h
...
class FiniteGreedyPolicy : public AbstractPolicy
{
    public:
        FiniteGreedyPolicy( AbstractQFunction* qvm, AbstractResponseModule* rm );
